...
После подготовки нужных пакетов вызываем функцию Ирисов Фишеров и задаем количество ближайших соседей, размер шага, и координаты Х и У из функции Фишера.  Так же присваиваем цвет для Ирисам Фишера и  областям, на которых находятся  Ирисы Фишера.
